...
public class DogService {
    ...
    @RequestMapping(value = "/dogs/getAllDogsRegion/{name}", method = RequestMethod.GET)
    public List<Dog> getAllDogsRegion(@PathVariable String name){
        return dogRepository.getAllDogsRegion(name);
    }
